...
"[project]/app/wiadomosci/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
// --- MOCK API DATA (Symulacja danych rynkowych) ---
const MOCK_API_DATA = {
    rates: {
        reference: 5.50,
        wibor6m: 5.65,
...
// --- MOCK DANE PORTFELA (Symulacja pliku src/main/obligacje.json) ---
const MOCK_OBLIGACJE_JSON = [
    {
        id: 'EDO-2035',
        type: 'EDO',
        ...
        currentValue: 104.50,
        annualInterest: 'Inflacja + 1.50%',
        nextCouponDate: '01.03.2026',
        estimatedYield: 5.70 // Estymowany zysk roczny
    },
    {
        id: 'TOZ-2028',
        type: 'TOZ',
        name: 'Obligacje 3-letnie',
        quantity: 50,
        purchasePrice: 100.00,
        currentValue: 100.25,
        annualInterest: 'WIBOR 6M + 0.50%',
        nextCouponDate: '15.01.2026',
        estimatedYield: 6.15
    },
    {
        id: 'DOS-2027',
        type: 'DOS',
        name: 'Obligacje 2-letnie',
        quantity: 20,
        purchasePrice: 100.00,
        currentValue: 100.00,
        annualInterest: '5.20%',
        nextCouponDate: '01.07.2026',
        estimatedYield: 5.20
    }
];
// --- WIADOMOŚCI ---
const NEWS_ITEMS = [
    {
        ...
        date: "28.11.2025",
        category: "RPP",
        title: "Decyzja Rady Polityki Pieniężnej",
        content: "Rada zdecydowała o utrzymaniu stóp procentowych. Dla posiadaczy obligacji stałoprocentowych (DOS) to dobra wiadomość, gdyż rynkowe rentowności pozostają stabilne. Posiadacze TOZ mogą spać spokojnie – WIBOR nie powinien gwałtownie spadać."
    },
    {
        id: 2,
        date: "20.11.2025",
        category: "GUS",
        title: "Inflacja (CPI) w dół do 4,2%",
        content: "GUS potwierdza trend dezinflacyjny. Dla posiadaczy obligacji indeksowanych (EDO/COI) oznacza to, że w kolejnych okresach odsetkowych nominalne oprocentowanie może być niższe, ale realny zysk (powyżej inflacji) jest wciąż chroniony marżą."
    },
    {
        id: 3,
        date: "15.11.2025",
        category: "Rynek",
        title: "Popyt na obligacje 10-letnie rośnie",
        content: "Polacy chętniej wybierają EDO niż lokaty bankowe. W obliczu stabilizacji stóp, gwarancja marży 1,50% ponad inflację staje się bezkonkurencyjną ofertą na rynku bezpiecznych aktywów."
    }
];
// Funkcja symulująca pobranie obligacji z lokalnego JSON
const fetchUserObligacje = ()=>{
    return new Promise((resolve)=>{
        setTimeout(()=>{
            resolve(MOCK_OBLIGACJE_JSON);
        }, 1200); // Dłuższe opóźnienie dla portfela
    });
};
function WiadomosciPage() {
    _s();
    const [data, setData] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null);
    const [obligacje, setObligacje] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WiadomosciPage.useEffect": ()=>{
            const timer = setTimeout({
                "WiadomosciPage.useEffect.timer": ()=>{
                    setData(MOCK_API_DATA);
                    setLoading(false);
                }
            }["WiadomosciPage.useEffect.timer"], 800);
            return ({
                "WiadomosciPage.useEffect": ()=>clearTimeout(timer)
            })["WiadomosciPage.useEffect"];
        }
    }["WiadomosciPage.useEffect"], []);
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "WiadomosciPage.useEffect": ()=>{
            setLoadingObligacje(true);
            fetchUserObligacje().then({
                "WiadomosciPage.useEffect": (res)=>{
                    setObligacje(res);
    ...
    const totalValue = obligacje.reduce((sum, item)=>sum + item.quantity * item.currentValue, 0);
    const totalPurchase = obligacje.reduce((sum, item)=>sum + item.quantity * item.purchasePrice, 0);
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                ...
                                children: "Zobacz aktualne dane rynkowe i zrozum, jak wpływają na oprocentowanie Twoich obligacji (EDO, COI, TOZ)."
                            }, void 0, false, {
                                fileName: "[project]/app/wiadomosci/page.tsx",
                                lineNumber: 156,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("h2", {
                                        ...
                                        children: "Mój Portfel Obligacji (z obligacje.json)"
                                    }, void 0, false, {
                                        fileName: "[project]/app/wiadomosci/page.tsx",
                                        lineNumber: 165,
                                        columnNumber: 13
                            ...
                            loadingObligacje ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                style: {
                                    textAlign: 'center',
                                    padding: '40px',
                                    color: '#86868b'
                                },
                                children: "Ładowanie danych portfela..."
                            }, void 0, false, {
                                fileName: "[project]/app/wiadomosci/page.tsx",
                                lineNumber: 169,
                                columnNumber: 13
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        ...
                                                        children: "Wartość rynkowa portfela"
                                                    }, void 0, false, {
                                                        fileName: "[project]/app/wiadomosci/page.tsx",
                                                        lineNumber: 175,
                                                        columnNumber: 19
                                        ...
                                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("table", {
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tbody", {
                                                    children: obligacje.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("tr", {
                                                            style: {
                                                            ...
                                                            children: [
                                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("td", {
                                                                    ...
                                                                    children: [
                                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                                            style: {
                                                                                background: item.type === 'EDO' ? '#0071E315' : item.type === 'TOZ' ? '#34C75915' : '#FF2D5515',
                                                                                color: item.type === 'EDO' ? '#0071E3' : item.type === 'TOZ' ? '#34C759' : '#FF2D55',
                                                                                fontSize: '0.7rem',
                                                                                fontWeight: 600,
                                                                                padding: '4px 8px',
                                                                                borderRadius: '6px'
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(IndicatorCard, {
                                title: "Inflacja (CPI)",
                                value: data?.rates.inflation,
                                suffix: "%",
                                loading: loading,
                                color: "#FF2D55",
                                description: "Wskaźnik wzrostu cen towarów i usług konsumpcyjnych (wzrost cen).",
                                impact: "Kluczowy dla obligacji indeksowanych (EDO, COI, DOR). To do tej wartości doliczana jest marża w kolejnych latach, gwarantując zysk realny (ponad inflację)."
                            }, void 0, false, {
                                fileName: "[project]/app/wiadomosci/page.tsx",
                                lineNumber: 225,
                                columnNumber: 11
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(IndicatorCard, {
                                title: "Stopa Referencyjna NBP",
                                value: data?.rates.reference,
                                suffix: "%",
                                loading: loading,
                                color: "#0071E3",
                                description: "Główna stopa procentowa ustalana przez Radę Polityki Pieniężnej (RPP).",
                                impact: "Wyznacza koszt pieniądza w gospodarce. Jej poziom wpływa na rentowność nowo emitowanych obligacji oraz pośrednio na stawkę WIBOR."
                            }, void 0, false, {
                                fileName: "[project]/app/wiadomosci/page.tsx",
                                lineNumber: 236,
                                columnNumber: 11
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(IndicatorCard, {
                                title: "WIBOR 6M",
                                value: data?.rates.wibor6m,
                                suffix: "%",
                                loading: loading,
                                color: "#34C759",
                                description: "Stopa oprocentowania pożyczek na rynku międzybankowym na okres 6 miesięcy.",
                                impact: "Bezpośrednio steruje oprocentowaniem obligacji 3-letnich (TOZ). Im wyższy WIBOR w danym okresie, tym wyższy kupon odsetkowy otrzymasz."
                            }, void 0, false, {
                                fileName: "[project]/app/wiadomosci/page.tsx",
                                lineNumber: 247,
                                columnNumber: 11
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: NEWS_ITEMS.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        style: {
                                            display: 'flex',
                                            flexDirection: 'column',
                                            gap: '10px'
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                        ...
                        children: [
                            "Dane mają charakter poglądowy (symulacja na potrzeby demo). Ostatnia aktualizacja: ",
...
_s(WiadomosciPage, "4QEAapz/a+ez3/5SpGcR7Hw7GSI=");
_c = WiadomosciPage;
// --- KOMPONENT KARTY WSKAŹNIKA ---
function IndicatorCard({ title, value, suffix, loading, color, description, impact }) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        style: {
            background: '#FFF',
            borderRadius: '24px',
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: title.includes("Inflacja") ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$lucide$2d$react$2f$dist$2f$esm$2f$icons$2f$trending$2d$up$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__default__as__TrendingUp$3e$__["TrendingUp"], {
                                    size: 16,
                                    color: color
                                }, void 0, false, {
                                    fileName: "[project]/app/wiadomosci/page.tsx",
...
_c1 = IndicatorCard;
var _c, _c1;
__turbopack_context__.k.register(_c, "WiadomosciPage");
__turbopack_context__.k.register(_c1, "IndicatorCard");
...
//# sourceMappingURL=_d5755bf4._.js.map