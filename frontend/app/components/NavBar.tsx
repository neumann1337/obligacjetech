...
import { TrendingUp, Calculator, BookOpen, Home } from 'lucide-react';
...
export const NavBar = () => {
  ...
  const links = [
    ...
    { name: 'Poradnik', href: '/poradnik', icon: <BookOpen size={18} /> },
  ];
      ...
      <div className="flex w-full max-w-[980px] items-center justify-between">
        <Link href="/" className="no-underline">
          <div className="flex items-center gap-2 text-[1.1rem] font-bold text-[#1D1D1F] md:text-[1.2rem]">
            <div className="flex rounded-lg bg-gradient-to-br from-[#0071E3] to-[#00C7BE] p-1.5 text-white">
               <TrendingUp size={20} />
            </div>
                ...
                <div 
                  className={`
                    ...
                    ${isActive 
                      ...
                      : 'bg-transparent text-[#86868b] hover:text-gray-600'
                    }
                  `}
                >
